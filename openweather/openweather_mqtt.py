...
MQTT_SERVICE_HOST = os.getenv('MQTT_SERVICE_HOST', '192.168.18.243')
MQTT_SERVICE_PORT = int(os.getenv('MQTT_SERVICE_PORT', 1883))
MQTT_SERVICE_TOPIC = os.getenv('MQTT_SERVICE_TOPIC', 'weather')
...
if __name__ == "__main__":
    ...
    while True:
        ...
        try:
            ...
            # command="docker exec -it 7ba49eaed320 mosquitto_pub -h 192.168.18.243 -t \"weather\" -m \""+ str(msgs) + "\""
            # print(command)
